...
public class VisitorAdsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itemsview= inflater.inflate(R.layout.fragment_visitor_ads, container, false);


        mtoolbar = itemsview.findViewById(R.id.toolbar_tool);
        ((AppCompatActivity)getActivity()).setSupportActionBar(mtoolbar);
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(getString(R.string.myadRequests));
        ...
        if(mFirebaseUser != null)
        {
            ...
            likeRef = FirebaseDatabase.getInstance().getReference().child("users").child(userId).child("adsrequests");
    ...
    public void onStart() {
        ...
        if (mFirebaseUser != null) {
            ...
            firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Ads_data, VisitorAdsFragment.EntryViewHolder>(options) {
                @Override
                protected void onBindViewHolder(@NonNull final VisitorAdsFragment.EntryViewHolder entryViewHolder, final int i, @NonNull final Ads_data data) {
                    ...
                    entryViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            editor.putString("datakey","adsrequests");
                            editor.apply();
                            ...
                            display.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent = new Intent(getContext(), MyAdRequestDetailesDisplay.class);
                                    startActivity(intent);
                                }
                            });
                ...
                @NonNull
                @Override
                public VisitorAdsFragment.EntryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_ad_layout, parent, false);

                    return new VisitorAdsFragment.EntryViewHolder(view);
