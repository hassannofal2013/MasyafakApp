...
public class MyAdpublishedDetailesDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot)
                        {
                                    ...
                                    && snapshot.child(userId).child("email").exists())
                            {
                                ...
                                Intent intent = new Intent(MyAdpublishedDetailesDisplay.this, FreeDaysActivity.class);
                            ...
                            else
                            {
                                ...
                                Toast.makeText(MyAdpublishedDetailesDisplay.this, R.string.completeprofile, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(MyAdpublishedDetailesDisplay.this,RegisterActivity.class);
                                startActivity(intent);
                                finish();
                            }
                        }
                ...
                {
                    final AlertDialog alertadd = new AlertDialog.Builder(MyAdpublishedDetailesDisplay.this).create();
                    final LayoutInflater factory = LayoutInflater.from(MyAdpublishedDetailesDisplay.this);
                    ...
                    register.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(MyAdpublishedDetailesDisplay.this,LoginActivity.class);
                            startActivity(intent);
                        }
                    });
            ...
            mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot)
                {
                    ...
                    if ( ! image6St.equals(""))
                    {
                        ...
                        PagerAdapter adapter = new ViewPagerAdapter(MyAdpublishedDetailesDisplay.this, imageUrls);
        ...
        zoom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyAdpublishedDetailesDisplay.this,Full_Screen_ImageSliderActivity.class);
                startActivity(intent);
